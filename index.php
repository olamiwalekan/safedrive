...
<!--        <script src="js/validate.js" type="text/javascript"></script>
        ...
        $(function(){
                ...
                /* $('#signUP').click(function(){
                    $('.login-box').removeClass('see');
                    $('.login-box').addClass('unsee');
                    $('.signup-box').removeClass('unsee');
                    $('.signup-box').addClass('see');
                    $('.signup-box').animate({opacity: 1},5000);
                 });
                 
                 $('#logIN').click(function(){
                    $('.signup-box').removeClass('see');
                    $('.signup-box').addClass('unsee');
                    $('.login-box').removeClass('unsee');
                    $('.login-box').animate({opacity: 1},5000,"linear");
                 }); */
